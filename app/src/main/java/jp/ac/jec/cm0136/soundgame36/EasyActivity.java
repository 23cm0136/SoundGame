...
public class EasyActivity extends AppCompatActivity {
    ...
    public static final int CODE_RANK_EASY = 456;
    ...
    class ButtonClickAction implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (rightAnswer == 4) {
                if (clickTimes == 8) {
                    Toast.makeText(EasyActivity.this, clickTimes + "回クリックで完成! き、君は神か!", Toast.LENGTH_SHORT).show();
                } else if (clickTimes <= 16) {
                    Toast.makeText(EasyActivity.this, clickTimes + "回クリックで完成。", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(EasyActivity.this, clickTimes + "回クリックで完成…より一層の精進をすべし", Toast.LENGTH_SHORT).show();
                }

                if (rankEasy == -1 || clickTimes < rankEasy) {
                    SharedPreferences.Editor edtr = sp.edit();
                    edtr.putInt("EASY",clickTimes);
                    edtr.apply();
                }
            }
        }
...
//        findViewById(R.id.ibtn01).setOnClickListener(new ButtonClickAction());
        for (int id : imgButtons) {
            ...
            iBtn.setOnClickListener(new EasyActivity.ButtonClickAction());
        }
        initGame();
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rightAnswer == 4) {
                    ...
                    intent.putExtra("EASY",clickTimes);
                    setResult(CODE_RANK_EASY,intent);
                }
                finish();
            }
        });
    ...
    private void initGame() {
        int[] setItems = {R.raw.se_door01, R.raw.se_phone02, R.raw.se_whistle01, R.raw.se_drink02};
